...
const About = ({ coreValues, myExperience }) => {
  return (
    <Layout>
      <div>
        <h1 className={styles.aboutme_mainheading}>About Me</h1>
...
export async function getStaticProps() {
  const { coreValues, myExperience } = getJSONAboutData();

  return {
    props: { coreValues, myExperience },
  };
}
